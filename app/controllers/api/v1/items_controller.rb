class Api::V1::ItemsController < BaseController
  ...
  before_action :auth_by_manager_privilege!, only: [:create, :create_tag_associations, :destroy_tag_associations, :update_general, :bulk_import,:bulk_minimum_stock]
  ...
  [:create_tag_associations, :destroy_tag_associations, :update_general, :fix_quantity, :clear_field_entries, :update_field_entry, :bulk_minimum_stock,:bulk_import, :self_outstanding_requests, :self_loans].each do |api_action|
